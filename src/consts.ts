...
export const ACCOUNT_TYPE_OPTIONS: { value: string; labelKey: string }[] = [
...
export const ACCOUNT_NATURE_OPTIONS: { value: string; labelKey: string }[] = [
  { value: ACCOUNT_NATURE_DEBIT, labelKey: "accountNatureDebit" },
  { value: ACCOUNT_NATURE_CREDIT, labelKey: "accountNatureCredit" },
];

export const ACCOUNT_NATURE_LABEL_KEYS: Record<string, string> =
...
export const STMT_GROUP_LABEL_KEYS: Record<string, string> =
...
export const ACCOUNTING_ENTRY_TYPE_LABEL_KEYS: Record<string, string> =
...
export const ACCOUNTING_ENTRY_STATUS_LABEL_KEYS: Record<number, string> = {
...
export const ACCOUNTPROFILE_TYPE_LABEL_KEYS: Record<string, string> =
...
export const GENERAL_ACCOUNTTYPE_LABEL_KEYS: Record<string, string> =
...
export const TAX_ACCOUNTTYPE_LABEL_KEYS: Record<string, string> = {
