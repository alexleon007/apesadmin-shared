...
export declare const languages: {
    readonly es: {
        ...
        recalculate: string;
        dayDetail: string;
        noRecordsForDay: string;
        restDay: string;
        attendanceCalendar: string;
        selectCollaboratorToView: string;
        ...
        specialClosure: string;
        extraRestDay: string;
        overtimeRequest: string;
        justifyRequest: string;
        ...
        permissionWithPayDays: string;
        permissionWithoutPayDays: string;
        vacationDays: string;
        ...
        noExceptions: string;
        closePeriod: string;
        closeWithExceptionsWarning: string;
        reopenReason: string;
        adjustValue: string;
        oldValue: string;
        newValue: string;
        ...
        adjustedManually: string;
        missingpunchException: string;
        unresolvedIncidenceException: string;
        pendingRequestException: string;
        pendingOvertimeException: string;
        pendingCorrectionException: string;
        noScheduleException: string;
        forceClose: string;
        closedBy: string;
        closedAt: string;
