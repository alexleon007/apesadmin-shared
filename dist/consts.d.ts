...
export declare const ATTENDANCE_RECORD_TYPE_LABEL_KEYS: Record<string, string>;
export declare const ATTENDANCE_SOURCE_WIDGET = "widget";
export declare const ATTENDANCE_SOURCE_MANUAL = "manual";
export declare const ATTENDANCE_SOURCE_IMPORT = "import";
export declare const ATTENDANCE_INCIDENCE_ONTIME = "ontime";
export declare const ATTENDANCE_INCIDENCE_LATE = "late";
export declare const ATTENDANCE_INCIDENCE_ABSENT = "absent";
export declare const ATTENDANCE_INCIDENCE_EARLYLEAVE = "earlyleave";
export declare const ATTENDANCE_INCIDENCE_MISSINGPUNCH = "missingpunch";
export declare const ATTENDANCE_INCIDENCE_EXCESSBREAK = "excessbreak";
export declare const ATTENDANCE_INCIDENCE_PERMISSION = "permission";
export declare const ATTENDANCE_INCIDENCE_VACATION = "vacation";
export declare const ATTENDANCE_INCIDENCE_DISABILITY = "disability";
export declare const ATTENDANCE_INCIDENCE_JUSTIFIEDABSENCE = "justifiedabsence";
export declare const ATTENDANCE_INCIDENCE_UNJUSTIFIEDABSENCE = "unjustifiedabsence";
export declare const ATTENDANCE_INCIDENCE_TYPES: readonly ["ontime", "late", "absent", "earlyleave", "missingpunch", "excessbreak", "permission", "vacation", "disability", "justifiedabsence", "unjustifiedabsence"];
export declare const ATTENDANCE_INCIDENCE_MANUAL_TYPES: readonly ["permission", "vacation", "disability", "justifiedabsence", "unjustifiedabsence"];
export declare const ATTENDANCE_INCIDENCE_JUSTIFIABLE_TYPES: readonly ["late", "earlyleave", "missingpunch", "unjustifiedabsence"];
export declare const ATTENDANCE_INCIDENCE_ORIGIN_AUTO = "auto";
export declare const ATTENDANCE_INCIDENCE_ORIGIN_MANUAL = "manual";
export declare const ATTENDANCE_INCIDENCE_LABEL_KEYS: Record<string, string>;
export declare const ATTENDANCE_INCIDENCE_COLORS: Record<string, string>;
export declare const ATTENDANCE_CALENDAR_TYPEDOC = "attendance";
export declare const ATTENDANCE_IMPORT_ROW_OK = "ok";
export declare const ATTENDANCE_IMPORT_ROW_DUPLICATE = "duplicate";
export declare const ATTENDANCE_IMPORT_ROW_ERROR = "error";
export declare const ATTENDANCE_IMPORT_ROW_UNMATCHED = "unmatched";
export declare const ATTENDANCE_REQUEST_VACATION = "vacation";
export declare const ATTENDANCE_REQUEST_PERMISSION = "permission";
export declare const ATTENDANCE_REQUEST_DISABILITY = "disability";
export declare const ATTENDANCE_REQUEST_OVERTIME = "overtime";
export declare const ATTENDANCE_REQUEST_JUSTIFY = "justify_absence";
export declare const ATTENDANCE_REQUEST_CORRECTION = "correction";
export declare const ATTENDANCE_REQUEST_TYPES: readonly ["vacation", "permission", "disability", "overtime", "justify_absence", "correction"];
export declare const ATTENDANCE_REQUEST_TYPES_WITH_INCIDENCE: readonly ["vacation", "permission", "disability"];
export declare const ATTENDANCE_REQUEST_TYPE_INCIDENCE: Record<string, string>;
export declare const ATTENDANCE_REQUEST_LABEL_KEYS: Record<string, string>;
export declare const ATTENDANCE_REQUEST_PENDING = "pending";
export declare const ATTENDANCE_REQUEST_APPROVED = "approved";
export declare const ATTENDANCE_REQUEST_REJECTED = "rejected";
export declare const ATTENDANCE_REQUEST_CANCELLED = "cancelled";
export declare const ATTENDANCE_REQUEST_STATUSES: readonly ["pending", "approved", "rejected", "cancelled"];
export declare const ATTENDANCE_REQUEST_STATUS_LABEL_KEYS: Record<string, string>;
export declare const ATTENDANCE_CALENDAR_DAY_HOLIDAY = "holiday";
export declare const ATTENDANCE_CALENDAR_DAY_NONWORKING = "nonworking";
export declare const ATTENDANCE_CALENDAR_DAY_CLOSURE = "closure";
export declare const ATTENDANCE_CALENDAR_DAY_EXTRAREST = "extrarest";
export declare const ATTENDANCE_CALENDAR_DAY_TYPES: readonly ["holiday", "nonworking", "closure", "extrarest"];
export declare const ATTENDANCE_CALENDAR_DAY_LABEL_KEYS: Record<string, string>;
...
export declare const ACCOUNT_TYPE_LABEL_KEYS: Record<string, string>;
...
export declare const ACCOUNT_NATURE_LABEL_KEYS: Record<string, string>;
...
export declare const STMT_GROUP_LABEL_KEYS: Record<string, string>;
export declare const ACCOUNTING_ENTRY_TYPE_OPTIONS: {
    value: string;
    labelKey: string;
}[];
export declare const ACCOUNTING_ENTRY_TYPE_LABEL_KEYS: Record<string, string>;
...
export declare const ACCOUNTING_ENTRY_STATUS_LABEL_KEYS: Record<number, string>;
...
export declare const ACCOUNTPROFILE_TYPE_LABEL_KEYS: Record<string, string>;
