...
export type ChannelAdapterType = {
     ...
     */
    listTemplates?(params: ChannelTemplateListParamsType): Promise<ChannelTemplateType[]>;
    /** Envia una plantilla. Va con listTemplates: quien tiene una tiene la otra. */
    sendTemplate?(params: ChannelSendTemplateParamsType): Promise<ChannelSendTextResultType>;
};
...
export type MailFolderType = "INBOX" | "SENT" | "DRAFTS" | "TRASH" | "SPAM" | "ARCHIVE";
...
export type MailChannelTestType = {
    ok: boolean;
    errorKey?: string;
};
...
export type MailErrorKeyType = "mailErrAuth" | "mailErrDisabled" | "mailErrHost" | "mailErrSender" | "mailErrTls" | "mailErrTimeout" | "mailErrUnknown";
...
export type MailProviderType = {
    ...
    send: (opts: MailSendOptionsType) => Promise<{
        messageId: string;
    }>;
...
export type PromotionPayloadType = {
    name: string;
    day: "monday" | "tuesday" | "wednesday" | "thursday" | "friday" | "saturday" | "sunday" | "all" | "weekends" | "weekdays" | string;
    startDate: string;
    endDate: string;
    startHour: string;
    endHour: string;
